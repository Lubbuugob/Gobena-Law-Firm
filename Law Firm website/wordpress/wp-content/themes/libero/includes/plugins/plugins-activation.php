...
if(!function_exists('mkd_register_required_plugins')) {
    ...
    function mkd_register_required_plugins() {
        $plugins = array(
            array(
                'name' => esc_html__( 'WPBakery Visual Composer', 'libero' ),
                'slug'               => 'js_composer',
            ...
            array(
                'name' => esc_html__( 'Revolution Slider', 'libero' ),
                'slug'               => 'revslider',
            ...
            array(
                'name' => esc_html__( 'Mikado Core', 'libero' ),
                'slug'               => 'mikado-core',
            ...
            array(
                'name' => esc_html__( 'Mikado Instagram Feed', 'libero' ),
            ...
            array(
                'name' => esc_html__( 'Mikado Twitter Feed', 'libero' ),
            ...
            array(
	            'name'     => esc_html__( 'Envato Market', 'libero' ),
	            'slug'     => 'envato-market',
	            'source'   => 'https://envato.github.io/wp-envato-market/dist/envato-market.zip',
	            'required' => false
            ),
            array(
                'name'                  => esc_html__( 'WooCommerce', 'libero' ),
                'slug'                  => 'woocommerce',
                'external_url'          => 'https://wordpress.org/plugins/woocommerce/',
                'required'              => false
            ),
            array(
                'name'                  => esc_html__( 'Contact Form 7', 'libero' ),
                'slug'                  => 'contact-form-7',
