(function($){
    ...
    function mkdChangedInput () {
        ...
        $('.mkd-tabs-content form.mkd_ajax_form:not(.mkd-import-page-holder) .field.switch label:not(.selected)').on('click', function() {
            $('.mkd-input-change').addClass('yes');
        });
        ...
        $('.mkd-tabs-content form.mkd_ajax_form:not(.mkd-import-page-holder) #anchornav input').on('click',function() {
            if ($('.mkd-input-change.yes').length) {
    ...
    function mkdInitPortfolioItemsBox() {
        ...
        $('a.mkd-add-item').on('click',function (event) {
            event.preventDefault();
